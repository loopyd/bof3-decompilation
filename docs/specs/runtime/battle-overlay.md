...
| Canonical inventory store | `processed/inventory/inventory.sqlite` |
| Inventory evidence source | `processed/inventory/inventory.sqlite` views and metadata rows |
...
@source: `processed/inventory/inventory.sqlite`
