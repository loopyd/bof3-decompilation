...
| `emi/etc/shop/00` | `0x801D6600` | Shop program |
| `emi/etc/commu00/00` | `0x801F0200` | Fairy communication minigame |
| `emi/etc/bate/03` | `0x801D6600` | Battle-event content |
| `emi/etc/sisyou/00` | `0x801D6600` | Master/skill menu |
| `emi/battle/battle/03` | `0x801D5200` | Main battle program |
| `emi/battle/battle/15` | `0x80096800` | Battle program (alternate slot) |
| `emi/battle/batl_re2/01` | `0x80036D00` | Battle replay/result screen |
| `emi/scenario/scena00/00` | `0x801FC800` | Scenario controller |
| `emi/scenario/scena16/00` | `0x801FC800` | Scenario controller (late-game) |
| `emi/scenario/sce10eff/00` | `0x801FC800` | Scenario effect controller |
...
| `emi/world00/area030/04` | `0x801D2300` | World area code |
