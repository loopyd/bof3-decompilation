...
void func_801f0718(u8 source_index, u8 task_index) {
  ...
  if (COMMU00_TASK_TEMPLATE_TABLE[template_offset + 2u] == 0u) {
    task_slot->mode = 6u;
  ...
  task_slot->field_36 =
      (s16)(u16)COMMU00_TASK_TEMPLATE_TABLE[template_offset + 0u];
  task_slot->field_38 = 0;
  task_slot->field_3a =
      (s16)(u16)COMMU00_TASK_TEMPLATE_TABLE[template_offset + 1u];
  task_slot->field_3e =
