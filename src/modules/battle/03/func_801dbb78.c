...
u32 func_801dbb78(u8 arg0, u8 arg1) {
  ...
  if (arg1 < 3u) {
    ...
    BATTLE_ENEMY_BYTE_FC(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]) = 0x11u;
  }
  ...
  if (arg1 < 3u) {
    ...
    if (value < 1) {
      ...
      if ((u32)BATTLE_LOCAL_HALF_90(local_work) <= (u32)next_value) {
        BATTLE_LOCAL_HALF_88(local_work) = BATTLE_LOCAL_HALF_90(local_work);
    ...
    if (BATTLE_ENEMY_HALF_F8(enemy_work) != 0xffffu) {
      ...
      if (value < 1) {
        ...
        if ((u32)BATTLE_ENEMY_HALF_A0(enemy_work) <= (u32)next_value) {
          BATTLE_ENEMY_HALF_F8(enemy_work) = BATTLE_ENEMY_HALF_A0(enemy_work);
  ...
  if ((arg0 < 3u) &&
      ...
      (value != 0)) {
    if ((BATTLE_LOCAL_BYTE_82(&BATTLE_LOCAL_WORK_ARRAY[arg0]) == 'J') &&
        (func_800a3df8(arg0, arg1) == 0u)) {
      func_800a31e0(arg1, 0x40u);
    }
    if ((BATTLE_LOCAL_BYTE_82(&BATTLE_LOCAL_WORK_ARRAY[arg0]) == 'L') &&
        (func_800a3df8(arg0, arg1) == 0u)) {
      func_800a31e0(arg1, 8u);
    }
    if ((BATTLE_LOCAL_BYTE_82(&BATTLE_LOCAL_WORK_ARRAY[arg0]) == 'O') &&
        (func_800a3df8(arg0, arg1) == 0u)) {
