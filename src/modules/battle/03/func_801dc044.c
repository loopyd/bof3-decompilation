...
u32 func_801dc044(u8 arg0, u8 arg1, u16 arg2) {
  ...
  if (arg2 == 0xffffu) {
    if (arg0 < 3u) {
      BATTLE_SCRATCH_HALF_000 = BATTLE_PANEL_SLOT_MASK(
  ...
  if (arg0 < 3u) {
    ...
    if ((BATTLE_LOCAL_WORD_128(source_work) & 0x40u) != 0u) {
      BATTLE_GLOBAL_HALF_EC30C =
          BATTLE_GLOBAL_HALF_EC30C +
          ((BATTLE_GLOBAL_HALF_EC30C * BATTLE_LOCAL_BYTE_138(source_work)) >>
           1);
    ...
    if ((BATTLE_ENEMY_WORD_104(source_work) & 0x40u) != 0u) {
      BATTLE_GLOBAL_HALF_EC30C =
          (BATTLE_GLOBAL_HALF_EC30C * BATTLE_ENEMY_BYTE_114(source_work)) >> 1;
  ...
  if ((arg0 < 3u) && (arg1 >= 3u)) {
    ...
    source_state = BATTLE_LOCAL_BYTE_82(&BATTLE_LOCAL_WORK_ARRAY[arg0]);
    if (((source_state == 0x13u) || (source_state == 0x17u) ||
         (source_state == 0x33u)) &&
        (BATTLE_ENEMY_BYTE_7D(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]) ==
         4u)) {
  ...
  if (arg1 < 3u) {
    ...
    state_byte = BATTLE_LOCAL_BYTE_134(&BATTLE_LOCAL_WORK_ARRAY[arg1]);
  } else {
    flags =
        BATTLE_ENEMY_FLAGS_82(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]);
    state_byte =
        BATTLE_ENEMY_BYTE_100(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]);
  }
  ...
  if ((flags & 0x64u) != 0u) {
    if ((flags & 0x40u) != 0u) {
      ...
      if (arg1 < 3u) {
        func_800a36f0(BATTLE_LOCAL_BYTE_05(&BATTLE_LOCAL_WORK_ARRAY[arg1]),
                      0x40u);
        BATTLE_LOCAL_BYTE_121(&BATTLE_LOCAL_WORK_ARRAY[arg1]) = 0u;
      } else {
        func_800a36f0(
            BATTLE_ENEMY_BYTE_05(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]),
            0x40u);
        BATTLE_ENEMY_BYTE_FD(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]) =
            0u;
      }
      if ((s16)value == 0) {
        value = 1u;
  ...
  if (arg1 < 3u) {
    if ((BATTLE_LOCAL_WORD_134(&BATTLE_LOCAL_WORK_ARRAY[arg1]) & 0x10000u) !=
        0u) {
      value = 0u;
    }
  } else {
    if ((BATTLE_ENEMY_WORD_100(&BATTLE_ENEMY_WORK_ARRAY[(arg1 - 3u) & 0xffu]) &
         0x10000u) != 0u) {
      value = 0u;
    }
  }
