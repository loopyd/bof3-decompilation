...
u8 func_801e2e30(void) {
  ...
  if (BATTLE_GLOBAL_BYTE_62F0 == 2u) {
    ...
    do {
      if (func_801db524(index) == 0u) {
        total += BATTLE_WEIGHT_TABLE_0394[index +
                                          ((u32)BATTLE_GLOBAL_BYTE_44F58 * 2u)];
      }
      index += 1u;
    } while (index < 2u);
    ...
    do {
      if (func_801db524(index) == 0u) {
        sum += BATTLE_WEIGHT_TABLE_0394[index +
                                        ((u32)BATTLE_GLOBAL_BYTE_44F58 * 2u)];
  ...
  do {
    if (func_801db524(index) == 0u) {
      total += BATTLE_WEIGHT_TABLE_039C[index +
                                        ((u32)BATTLE_GLOBAL_BYTE_44F58 * 3u)];
    }
    index += 1u;
  } while (index < 3u);
