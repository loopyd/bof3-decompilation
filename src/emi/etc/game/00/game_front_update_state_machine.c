  ...
  switch (D_80143BB0) {
    ...
    case 5: {
      ...
      if (selection != 0xff && D_80143F1F != selection) {
        game_start_selection_fx(D_80181EBA[selection * 4], D_80181EBB[selection * 4], 100,
                      16);
      }
      if (D_80143F1E != 0xff) {
      ...
      selection = GAME_FRONT_SELECTION;
      if (selection != 0xff && D_80143F1F != selection) {
        game_stop_selection_fx(D_80181EBA[selection * 4], D_80181EBB[selection * 4]);
      }
      D_80143B90 = 1;
      break;
    }
