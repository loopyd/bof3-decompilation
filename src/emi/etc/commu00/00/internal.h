#ifndef BOF3_SRC_EMI_COMMU00_00_INTERNAL_H
#define BOF3_SRC_EMI_COMMU00_00_INTERNAL_H
...
#define COMMU00_TASK_SLOTS VPTR(Commu00TaskSlot, 0x80146888u)
...
#define COMMU00_FAIRY_PROGRESS       VPTR(u8, 0x801448ecu)
#define COMMU00_FAIRY_SLOT_INDEX     VPTR(u8, 0x801448edu)
#define COMMU00_BATTLE_COUNT         VPTR(u32, 0x8014502cu)
#define COMMU00_STATE                VPTR(u8, 0x80143bb0u)
#define COMMU00_ITEM_NAME            VPTR(u8, 0x801490d8u)
#define COMMU00_ACTIVE_UI            VPPTR(u8, 0x801f2948u)
