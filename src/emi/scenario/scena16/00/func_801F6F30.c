  ...
  if (func_8015B5D4(SCENA16_D_8014686C, 2) == 0) {
    ...
    *(volatile u8*)0x1f800000u = object_index;
    ...
    if (object_index != 0xffu) {
      ...
      object[0] = 1u;
      object[5] = 0x13u;
      *(volatile s32*)(object + 0x64) = (s32)((s16)SCENA16_D_801492D8 - (s16)0xaau);
    ...
    func_8015C100();
    *(volatile u32*)0x80145ec4u = 0x330000u;
    *(volatile u32*)0x80145ec8u = 0x400000u;
    func_8015B580(SCENA16_D_8014686C, 2);
  } else if (func_8015B5D4(SCENA16_D_8014686C, 10) == 0) {
    func_8015B580(SCENA16_D_8014686C, 10);
    func_801BE1B0(0u);
    *(volatile u32*)0x80149308u = 0x260000u;
    *(volatile u32*)0x8014930cu = 0x1b8000u;
  }
}
