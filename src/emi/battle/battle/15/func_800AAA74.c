...
void func_800AAA74(void) {
  ...
  mode = MMIO8(0x80144f58u);

  switch (mode) {
    case 1u:
      ((void (*)(volatile u16*, u32))0x801654f4u)(
          (volatile u16*)0x80145f44u, (u32)(MMIO16(0x80145f44u) >> 1u));
      ((void (*)(volatile u16*, s32))0x801654f4u)(
          (volatile u16*)0x80145f46u, -(s32)(MMIO16(0x80145f46u) >> 2u));
      ((void (*)(volatile u8*, u8))0x80165694u)((volatile u8*)0x80145f59u,
                                                MMIO8(0x80145f59u));
      return;
    case 2u:
      active_count = MMIO8(0x801462f0u);
      slot = 0u;
      while (slot < active_count) {
        if (!((s32 (*)(s32))0x801db524u)((s32)slot)) {
          ...
          ((void (*)(volatile u16*, s32))0x801654f4u)(
              ...
              -(s32)(MMIO16(0x80145f48u + slot_offset) >> 2u));
        }
        slot += 1u;
      }
      return;
    case 3u:
      ...
      while (slot < active_count) {
        if (!((s32 (*)(s32))0x801db524u)((s32)slot)) {
          slot_offset = (u32)slot * 0x140u;
          MMIO16(0x80145f48u + slot_offset) = MMIO16(0x80145f48u);
          panel_offset = (volatile u16*)(state_base + slot_offset + 0x5f04u);
          ((void (*)(volatile u16*, s32))0x801654f4u)(
              panel_offset + (0x42u / 2u),
              -(s32)(MMIO16(0x80145f46u + slot_offset) >> 1u));
        }
        slot += 1u;
      }
      break;
    case 4u:
      ((void (*)(volatile u16*, u32))0x801654f4u)(
          (volatile u16*)0x801461cau, (u32)(MMIO16(0x801461cau) >> 1u));
      ((void (*)(volatile u16*, s32))0x801654f4u)(
          (volatile u16*)0x80145f4au, -(s32)(MMIO16(0x80145f4au) >> 2u));
      ((void (*)(volatile u16*, s32))0x801654f4u)(
          (volatile u16*)0x80145f44u, -(s32)(MMIO16(0x80145f44u) >> 2u));
      break;
  }
}
