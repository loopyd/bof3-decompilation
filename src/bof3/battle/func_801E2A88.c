 ...
 * @status partial
 * @match 8.15
 * @residual non-exact live audit: 11/135 instructions; 540 original bytes versus 484 current.
 */
s8 func_801E2A88(u8 arg0) {
  ...
  if (BATTLE_GLOBAL_BYTE_6375 == 1u) {
    ...
    if ((flags & 1u) != 0u) {
      value = (s8)pickTargetOrFf((s8)arg0);
      if (value != -1) {
        return value;
      }
    ...
    if ((kind_flags & 0x20u) != 0u) {
      return (s8)pickTargetByMode((s8)arg0);
    }
  }
