...
extern void drawSprite(s16 x, s16 y, u8 sprite_id, u8 flags);
 ...
 * @status partial
 * @match 47.69
 * @residual non-exact live audit: 31/65 instructions; 260 original bytes versus 244 current.
 */
void func_801AF390(s16 base_x, s16 base_y, const u8* record_table, u8 flags) {
  ...
  for (;;) {
    ...
    drawSprite(x, y, sprite_id, flags & 0xff);
