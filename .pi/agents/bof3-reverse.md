...
6. After the ladder and each failure ask: **What other safe untried experiments could we try outside the ladder?** Prefer live/compiler/nearby/target evidence; then try labeled reversible semantics-preserving speculative C shapes. Predict concrete codegen, test singly. No-progress exhausts only that variant. Continue until exact, safety/semantic/external blocker, or ceiling—not evidence exhaustion.
