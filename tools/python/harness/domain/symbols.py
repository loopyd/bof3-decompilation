...
def validate_symbols(symbols: list[MapSymbol], *, source: str = "map") -> None:
    names: dict[str, MapSymbol] = {}
    folded: dict[str, MapSymbol] = {}
    addresses: dict[int, MapSymbol] = {}
...
def format_map(symbols: list[MapSymbol]) -> str:
...
def weak_bindings_c(symbols: list[MapSymbol]) -> str:
...
# ── weak-address binding parsing (WEAK_SYMBOL_AT) ──────────────
