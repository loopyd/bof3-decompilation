...
.PHONY: help venv doctor doctor-open setup-open setup pipeline extract inventory ghidra decomp-full-ready harness harness-ready lift-ready configure build test fmt format format-c format-python
