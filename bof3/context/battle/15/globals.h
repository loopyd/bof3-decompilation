#ifndef BOF3_CONTEXT_15_GLOBALS_H
#define BOF3_CONTEXT_15_GLOBALS_H
...
#define BOF3_BATTLE_SELECTION_RING_FLAG(index) (*(volatile u8*)(0x801eb5b1u + ((index) * 8u)))
#define BOF3_BATTLE_SELECTION_RING_HANDLE(index) (*(volatile u32*)(0x801eb5b4u + ((index) * 8u)))
#define BOF3_BATTLE_SELECTION_SAVED_GROUP(index) (*(volatile u8*)(0x801454f4u + ((index) * 3u)))
#define BOF3_BATTLE_SELECTION_SAVED_SCROLL(index) (*(volatile u8*)(0x801454f5u + ((index) * 3u)))
#define BOF3_BATTLE_SELECTION_SAVED_CURSOR(index) (*(volatile u8*)(0x801454f6u + ((index) * 3u)))
#define BOF3_BATTLE_SELECTION_KIND_FLAGS(kind) (*(volatile u8*)(0x801ca718u + ((kind) * 0x14u)))
#define BOF3_BATTLE_SELECTION_KIND_MASK(kind) (*(volatile u16*)(0x801ca71cu + ((kind) * 0x14u)))
#define BOF3_BATTLE_SELECTION_KIND_NAME_ID(kind) (*(volatile u16*)(0x801ca71eu + ((kind) * 0x14u)))
...
#define BOF3_BATTLE_SECONDARY_GROUP_TABLE(index) (*(volatile u8**)(0x801c893cu + ((index) * 4u)))
#define BOF3_BATTLE_SELECTION_PANEL_FLAGS(index) (*(volatile u32*)(0x80145fb4u + ((index) * 0x140u)))
...
#define BOF3_BATTLE_PANEL_SLOT_KIND(slot_index) (*(volatile u8*)(0x80145f12u + ((u32)(slot_index) * 0x140u)))
#define BOF3_BATTLE_PANEL_SLOT_MASK(kind) (*(volatile u8*)(0x801c90ebu + ((u32)(kind) * 0x18u)))
#define BOF3_BATTLE_LOCAL_PANEL_ENTRY_COUNT (*(volatile u8*)0x801eb5a8u)
#define BOF3_BATTLE_LOCAL_PANEL_OWNER_KIND(index) (*(volatile u8*)(0x801eb6acu + ((u32)(index) * 0x118u)))
#define BOF3_BATTLE_LOCAL_PANEL_ENTRY(index) (*(volatile BattleLocalPanelEntry*)(0x801ed9b0u + ((u32)(index) * 4u)))
#endif
