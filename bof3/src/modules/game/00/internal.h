...
#define GLOBAL_WORK_PTR (*(volatile u8**)0x80146250u)
...
#define GAME_ENTRY0_STATE            (*(volatile u16*)0x80143b90u)
#define GAME_ENTRY0_SUBSTATE         (*(volatile u16*)0x80143b92u)
#define GAME_ENTRY0_WORLD_PHASE      (*(volatile u8*)0x80143bb0u)
#define BOF3_GAME_WORLD_STATE             (*(volatile u16*)0x80143f00u)
#define GAME_ENTRY0_SELECTION_SEED   (*(volatile u8*)0x80143f1fu)
#define GAME_ENTRY0_ACTIVE_SELECTION (*(volatile u32*)0x80144fc0u)
