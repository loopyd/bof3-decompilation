...
void func_801f6f30(void) {
  if (func_8015b5d4(BOF3_SCENA16_DAT_8014686c, 2) == 0) {
    ...
    BOF3_SCENA16_DAT_80146864 = 0u;
    func_80154fd8(0x300u);
    func_801c601c(0u);
    BOF3_SCENA16_DAT_801492d8 = (u16)(BOF3_SCENA16_DAT_801492d8 + 0xaau);
    ...
    *(vu8*)0x1f800000u = object_index;
    ...
    if (object_index != 0xffu) {
      ...
      object[5] = 0x13u;
      *(vs32*)(object + 0x64) =
          (s32)((s16)BOF3_SCENA16_DAT_801492d8 - (s16)0xaau);
    ...
    *(vu32*)0x80145ec8u = 0x400000u;
    func_8015b580(BOF3_SCENA16_DAT_8014686c, 2);
  } else if (func_8015b5d4(BOF3_SCENA16_DAT_8014686c, 10) == 0) {
    func_8015b580(BOF3_SCENA16_DAT_8014686c, 10);
    func_801be1b0(0u);
