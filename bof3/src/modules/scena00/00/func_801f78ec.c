 ...
 */
void func_801f78ec(s32 x0, s32 y0, s16 angle0, s32 x1, s32 y1, s16 angle1,
                   u8 r, u8 g, u8 b) {
  ...
  ((void(*)(volatile s16*, volatile s16*, volatile void*, volatile void*))0x801794c8u)(
      coord_stack, coord_stack, (volatile void*)((volatile u8*)global_obj + 0x18u),
  ...
  ((void(*)(u8, s32))0x8014e5a0u)(REG8((u32)((volatile u8*)REG32(0x1f800044u) + 0x29u)), 0x10u);
}
