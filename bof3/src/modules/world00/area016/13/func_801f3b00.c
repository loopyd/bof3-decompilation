...
void func_801f3b00(s32 arg0, s32 arg1) {
  ...
  SetDrawMode((DR_MODE*)BOF3_WORLD00_AREA016_PRIMITIVE_PTR, 0, 0, tpage, 0);
  ...
  helper_state = func_80166cb0(BOF3_WORLD00_AREA016_GLOBAL_HALF_930A,
                               BOF3_WORLD00_AREA016_GLOBAL_HALF_930E);

  if ((((u8)(helper_state + 0x60)) < 2u) || (helper_state == (s8)0xae) ||
      ((BOF3_WORLD00_AREA016_GLOBAL_HALF_625A & 0x1000u) != 0u)) {
    for (i = 0; i < 6; i += 1) {
      if ((BOF3_WORLD00_AREA016_MARKER_TABLE[i].mask &
           BOF3_WORLD00_AREA016_GLOBAL_HALF_5AB4) != 0u) {
        func_801f39d8((s16)(arg0 + 0x38), (s16)(arg1 + 8),
                      BOF3_WORLD00_AREA016_MARKER_TABLE[i].field_02);
        break;
      }
    }
  } else {
    ...
    for (i = 0; i < 6; i += 1) {
      if ((BOF3_WORLD00_AREA016_MARKER_TABLE[i].mask &
        ...
        func_801f39d8(
            ...
            (u32)(BOF3_WORLD00_AREA016_MARKER_TABLE[i].field_02 + 1u));
        break;
      }
    }
  }
  ...
  if (((u8)(helper_state + 0x60)) < 2u) {
    for (i = 0; i < 8; i += 1) {
      if ((BOF3_WORLD00_AREA016_MARKER_TABLE[i].mask &
           BOF3_WORLD00_AREA016_GLOBAL_HALF_5AC0) != 0u) {
  ...
  if ((func_801b6610(BOF3_WORLD00_AREA016_GLOBAL_HALF_930A,
                     BOF3_WORLD00_AREA016_GLOBAL_HALF_930E) != 0u) ||
      ((BOF3_WORLD00_AREA016_GLOBAL_HALF_625A & 0x1000u) != 0u) ||
      (((BOF3_WORLD00_AREA016_STREAM_HINT & 0x7fu) == 0x0cu) ||
       ((BOF3_WORLD00_AREA016_GLOBAL_HALF_6258 & 0x4000u) != 0u))) {
