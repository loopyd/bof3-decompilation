...
void func_801f362c(void) {
  ...
  state_base = BOF3_WORLD00_AREA024_STATE_BASE;
  state_offset = BOF3_WORLD00_AREA024_STATE_OFFSET;
  vertex_dst = BOF3_WORLD00_AREA024_VERTEX_DST;
  vertex_src = BOF3_WORLD00_AREA024_VERTEX_SRC;
  i = 0u;

  do {
    state_offset[4] = (s16)(state_offset[4] +
                            (s16)(BOF3_WORLD00_AREA024_GLOBAL_HALF_3E6C & 1u));
