...
void func_801d195c(s16 arg0, s16 arg1) {
  ...
  if (BOF3_WORLD00_AREA030_GLOBAL_BYTE_3FC9 != 0u) {
    temp = func_8015477c(BOF3_WORLD00_AREA030_GLOBAL_HALF_3FFC,
                         BOF3_WORLD00_AREA030_GLOBAL_HALF_4000);
    if (temp < 0) {
      temp = (s16)(temp + 0x1f);
    }
  ...
  *(volatile u8*)(primitive + 6) = 0u;
  ...
  if (BOF3_WORLD00_AREA030_GLOBAL_BYTE_3FC9 == 4u) {
    icon_y = 0xb4;
    if (BOF3_WORLD00_AREA030_GLOBAL_HALF_4006 < 1) {
      temp = BOF3_WORLD00_AREA030_GLOBAL_HALF_4006;
      if (temp < 0) {
        temp = (s16)(temp + 0x1f);
      }
