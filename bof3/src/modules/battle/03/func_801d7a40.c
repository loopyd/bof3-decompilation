...
void func_801d7a40(s16 arg0, s16 arg1) {
  ...
  do {
    if (index != BATTLE_GLOBAL_BYTE_62F4) {
      ...
      if ((index >= 2u) && (index < 4u) &&
          ((*(volatile u32*)(BATTLE_GLOBAL_PTR_BF08 + 0x128u) & 2u) !=
           0u)) {
        color = 0x40u;
      }
      ...
      func_801644d8(index,
                    (s32)arg0 + BATTLE_ICON_OFFSET_TABLE_AE94[index * 2u] -
                        (s32)(size >> 1),
                    (s32)arg1 +
                        BATTLE_ICON_OFFSET_TABLE_AE94[index * 2u + 1] -
                        (s32)(size >> 1),
  ...
  color = 0x80u;
  if ((BATTLE_GLOBAL_BYTE_62F4 < 5u) &&
      (BATTLE_GLOBAL_BYTE_62F4 >= 2u) &&
  ...
  if (size == 0u) {
    func_801644d8(
        ...
        (s32)arg0 +
            BATTLE_ICON_OFFSET_TABLE_AE94[BATTLE_GLOBAL_BYTE_62F4 *
                                               2u],
        (s32)arg1 + BATTLE_ICON_OFFSET_TABLE_AE94
                        [BATTLE_GLOBAL_BYTE_62F4 * 2u + 1],
        0x10, 0x10, color);
  } else {
    func_801d7d10(
        BATTLE_GLOBAL_BYTE_62F4,
