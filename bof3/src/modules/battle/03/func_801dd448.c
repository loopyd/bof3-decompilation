...
u8 func_801dd448(void) {
  ...
  if (((BATTLE_LOCAL_WORD_124(BATTLE_LOCAL_WORK_PTR) & 1u) == 0u) &&
      ...
      ((BATTLE_LOCAL_FLAGS_80(BATTLE_LOCAL_WORK_PTR) & 0x4864u) ==
       0u) &&
      ((BATTLE_GLOBAL_BYTE_6375 != 4u) ||
       (BATTLE_GLOBAL_HALF_63C0 != 0xa1u)) &&
      ((BATTLE_GLOBAL_BYTE_63CE == 0u) ||
       ((BATTLE_LOCAL_WORD_128(BATTLE_LOCAL_WORK_PTR) & 0x10u) !=
        0u))) {
    if ((BATTLE_LOCAL_WORD_124(BATTLE_LOCAL_WORK_PTR) & 0x8000u) ==
        0u) {
