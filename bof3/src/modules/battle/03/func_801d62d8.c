  ...
  do {
    ...
    if (func_801d64c4(index) == 0u) {
      if (((BOF3_BATTLE_LOCAL_WORD_128(battle_work) & 2u) != 0u) &&
          ((BOF3_BATTLE_LOCAL_WORD_128(battle_work) & 0x20u) == 0u)) {
        if ((u32)BOF3_BATTLE_LOCAL_HALF_8A(battle_work) <
            (u32)((BOF3_BATTLE_GLOBAL_HALF_63B8 + 1u) >> 1)) {
          ...
          BOF3_BATTLE_LOCAL_HALF_8A(battle_work) -=
              (BOF3_BATTLE_GLOBAL_HALF_63B8 + 1u) >> 1;
          BOF3_BATTLE_LOCAL_HALF_1E(battle_work) =
              (BOF3_BATTLE_GLOBAL_HALF_63B8 + 1u) >> 1;
          if (BOF3_BATTLE_LOCAL_HALF_1E(battle_work) != 0u) {
        ...
        BOF3_BATTLE_LOCAL_WORD_128(battle_work) &= 0xffffffdful;
      }
    }
    index += 1u;
  } while (index < 3u);
