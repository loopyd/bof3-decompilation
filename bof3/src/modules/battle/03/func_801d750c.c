...
void func_801d750c(s32 arg0, s32 arg1) {
  ...
  func_801d9ab4((s16)arg0, (s16)arg1, (BOF3_BATTLE_GLOBAL_BYTE_62F0 * 2u) + 10u,
                1);
  func_801d9ab4((s16)arg0, (s16)(arg1 + 0x18),
                (BOF3_BATTLE_GLOBAL_BYTE_62F0 * 2u) + 11u, 1);
  func_801d9c80((s16)arg0, (s16)(arg1 + 2),
                BOF3_BATTLE_GLOBAL_BYTE_62F0 + 0x0du, 1);
  ...
  index = 0u;
  if (BOF3_BATTLE_GLOBAL_BYTE_62F0 != 0u) {
    do {
      s32                         slot_x;
      ...
      func_801d9e9c(
          ...
          BOF3_BATTLE_ICON_OFFSET_TABLE_AE94[(index + 0x0d) * 2u],
          BOF3_BATTLE_ICON_OFFSET_TABLE_AE94[(index + 0x0d) * 2u + 2u], 0);

      if (BOF3_BATTLE_LOCAL_HALF_8A(battle_work) != 0u) {
        func_801da5a8(
            (s16)slot_x, (s16)(arg1 + 0x0e),
            (s16)(arg0 +
                  BOF3_BATTLE_ICON_OFFSET_TABLE_AE94[(index + 0x0d) * 2u] +
        ...
        if (BOF3_BATTLE_ICON_OFFSET_TABLE_AE94[(index + 0x0d) * 2u + 2u] !=
            0u) {
          func_801da5a8(
              (s16)(arg0 +
                    BOF3_BATTLE_ICON_OFFSET_TABLE_AE94[(index + 0x0d) * 2u] +
      ...
      func_801d94d4(
          (s16)(arg0 + 0x48), (u16)(arg1 + 0x0f),
          (BOF3_BATTLE_LOCAL_HALF_8A(battle_work) != 0u &&
           ((BOF3_BATTLE_LOCAL_FLAGS_80(battle_work) & 0x4000u) == 0u))
              ? ((BOF3_BATTLE_LOCAL_HALF_8A(battle_work) <
                  (BOF3_BATTLE_LOCAL_HALF_92(battle_work) >> 2))
                 << 2)
              : 2u,
          BOF3_BATTLE_LOCAL_HALF_88(battle_work));
