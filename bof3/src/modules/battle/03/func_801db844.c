...
u8 func_801db844(u32 arg0) {
  if (arg0 < 3u) {
    ...
    return (BATTLE_GLOBAL_BYTE_6324 != 2u) &&
           (BATTLE_GLOBAL_BYTE_6324 != 3u);
  }
  ...
  if ((BATTLE_ENEMY_FLAGS_82(&BATTLE_ENEMY_WORK_ARRAY[arg0]) &
       0x4164u) != 0u) {
    return 0u;
  }
  if ((BATTLE_GLOBAL_BYTE_63CE != 0u) &&
      ((BATTLE_ENEMY_WORD_104(&BATTLE_ENEMY_WORK_ARRAY[arg0]) &
        0x10u) == 0u)) {
    return 0u;
  }
  if ((BATTLE_ENEMY_WORD_104(&BATTLE_ENEMY_WORK_ARRAY[arg0]) &
       0x4000u) != 0u) {
    return 0u;
  }

  return (BATTLE_GLOBAL_BYTE_6324 != 1u) &&
         (BATTLE_GLOBAL_BYTE_6324 != 3u);
}
