...
void func_80096fbc(void) {
...

  {
    ...
    active_selection_slot = (u8*)BOF3_BATTLE_ACTIVE_SELECTION_SLOT_PTR;
    active_selection_slot[1] = 4u;
  }
  func_80097ec0();

  active_selection_flags =
      *(u32*)(((u8*)BOF3_BATTLE_ACTIVE_SELECTION_SLOT_PTR) + 0x10);
  ...
  selection_root_state = BOF3_BATTLE_SELECTION_ROOT_STATE;
  source_slot = ((u8*)BOF3_BATTLE_ACTIVE_MESSAGE_SLOT_PTR)[5];
  ((u8*)0x80140000u)[0x62e4u] = 0u;
  BOF3_BATTLE_SELECTION_ROOT_STATE = selection_root_state + 1u;
