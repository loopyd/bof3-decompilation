...
/* does: handles battle camera adjustment during the selection phase. depending
...
void func_800aaa74(void) {
  ...
  switch (mode) {
  case 1u:
    ((void(*)(volatile u16*, u32))0x801654f4u)((volatile u16*)0x80145f44u,
      (u32)(REG16(0x80145f44u) >> 1u));
    ((void(*)(volatile u16*, s32))0x801654f4u)((volatile u16*)0x80145f46u,
      -(s32)(REG16(0x80145f46u) >> 2u));
  ...
  case 2u:
    ...
    while (slot < active_count) {
      if (!((s32(*)(s32))0x801db524u)((s32)slot)) {
        ...
        ((void(*)(volatile u16*, s32))0x801654f4u)(panel_offset + (0x44u / 2u),
  ...
  case 3u:
    ...
    while (slot < active_count) {
      if (!((s32(*)(s32))0x801db524u)((s32)slot)) {
        ...
        panel_offset = (volatile u16*)(state_base + slot_offset + 0x5f04u);
        ((void(*)(volatile u16*, s32))0x801654f4u)(panel_offset + (0x42u / 2u),
    ...
    break;
  case 4u:
    ((void(*)(volatile u16*, u32))0x801654f4u)((volatile u16*)0x801461cau,
      (u32)(REG16(0x801461cau) >> 1u));
    ((void(*)(volatile u16*, s32))0x801654f4u)((volatile u16*)0x80145f4au,
      -(s32)(REG16(0x80145f4au) >> 2u));
    ((void(*)(volatile u16*, s32))0x801654f4u)((volatile u16*)0x80145f44u,
      -(s32)(REG16(0x80145f44u) >> 2u));
    break;
  }
}
