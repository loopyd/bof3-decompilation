...
void func_800b0498(void) {
  ...
  ((void(*)(s32, s32, s32, s32, s32, s32))0x801ae3f0u)(
      draw_x, draw_y,
      ((s32)REG8((u32)(task_root + 8u)) * 8) - 0xf,
      ((s32)REG8((u32)(task_root + 9u)) * 8) - 0x27,
      0, (s32)REG8(0x80144952u));
  ...
  panel_count = ((u16)REG16((u32)(message_slot + 0x8au)) < cursor_index) ? 7u : 0u;

  ((void(*)(s16, s16, s32, volatile u32*))0x8014ff0cu)(
      (s16)((u16)REG16((u32)(task_root + 4u)) + 0x88u),
      (s16)((u16)REG16((u32)(task_root + 6u)) + 0xcu),
      (s32)panel_count, (volatile u32*)0x800b6d1cu);

  ((void(*)(volatile u16*, volatile void*, u8))0x8017e3f4u)(
      (volatile u16*)0x80145ad4u,
      (volatile void*)0x80096a04u,
      REG8(0x801463b8u));
  ...
  ((void(*)(s16, s16, s32, volatile void*))0x8014ff0cu)(
      ...
      (s16)((u16)REG16((u32)(task_root + 6u)) + 0xcu),
      (s32)panel_count, (volatile void*)0x80145ad4u);
  ...
  if (REG8(0x801462e3u) == 4u) {
    ...
    if ((s8)sel_substate == (s8)-1) {
      ...
      ((void(*)(s32, s32, s32, s8))0x801647c4u)((s32)(u16)cursor_x, (s32)(u16)cursor_y, 0, (s8)-1);
    } else {
      task_root = (volatile u8*)REG32(0x80148648u);
      cursor_x = (s16)((u16)REG16((u32)(task_root + 4u)) + 0xeu +
      ...
      cursor_y = (s16)((u16)REG16((u32)(task_root + 6u)) + 0x2cu +
                        ((u32)sel_substate << 5u));
      ((void(*)(s32, s32, s32, s8))0x801647c4u)((s32)(u16)cursor_x, (s32)(u16)cursor_y, 0, (s8)sel_substate);
    }
  }
