...
s16 func_800a2880(u8 battler_index, u16 base_value, u8 element_flag) {
  ...
  if (rule_selection != 0u) {
    if (element_flag != 0u) {
      element_mod = ((s16(*)(u8, u16, u32))0x800a2ef0u)(battler_index, rule_selection, 0x51eb851fu);
    } else {
  ...
  modifier_table = (volatile s16*)(0x800b0000u + (((random_bonus & 7u) * 2u) + 0x492cu));
  defence_bonus = (adjusted_value * (u32)*modifier_table) / 10000u;

  if ((REG8(0x80146394u) < 3u) && (REG8(0x80144f58u) == 2u) && (defence_bonus > 0u)) {
  ...
  if (battler_index < 3u) {
    ...
    defence_bonus /= 2u;
    if (REG32(0x801eb6d0u + ((u32)(battler_index - 3u) * 0x118u) + 4u) & 0x200u) {
      defence_bonus /= 2u;
    }
