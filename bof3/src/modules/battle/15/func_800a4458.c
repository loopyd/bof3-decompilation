...
void func_800a4458(void) {
  ...
  do {
    ...
    if (REG32(0x80145fb4u + slot_offset + 4u) & 0x2u) {
      ...
      base_x_adj = (base_x - (((base_x * (s32)REG8(0x80145f1eu + slot_offset)) + 5) / 10));
      ...
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xbfu)) = template_u8[0xau];
      REG8(0x80145f2fu + slot_offset) = template_u8[0xau];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc0u)) = template_u8[0xbu];
      REG8(0x80145f30u + slot_offset) = template_u8[0xbu];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc1u)) = template_u8[0xcu];
      REG8(0x80145f31u + slot_offset) = template_u8[0xcu];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc2u)) = template_u8[0xdu];
      REG8(0x80145f32u + slot_offset) = template_u8[0xdu];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc3u)) = template_u8[0xeu];
      REG8(0x80145f33u + slot_offset) = template_u8[0xeu];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc4u)) = template_u8[0xfu];
      REG8(0x80145f34u + slot_offset) = template_u8[0xfu];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc5u)) = template_u8[0x10u];
      REG8(0x80145f35u + slot_offset) = template_u8[0x10u];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc6u)) = template_u8[0x11u];
      REG8(0x80145f36u + slot_offset) = template_u8[0x11u];
      REG8((u32)(player_base + slot_offset + 0x5e90u + 0xc7u)) = template_u8[0x12u];
